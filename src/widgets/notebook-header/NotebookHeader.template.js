    ...
    <div class="notebook-header__top">
        ...
        <div class="notebook-header__center">
            ...
            <div class="notebook-header__icons">
                ${ctx.isOwner ? `<button class="notebook-header__icon-btn notebook-header__edit-btn" title="Переименовать">
                ...
                ${ctx.isOwner ? `<button class="notebook-header__icon-btn notebook-header__share-btn" title="Поделиться">
